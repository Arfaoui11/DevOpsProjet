...
pipeline {
    environment {
        registry = "siwarbr/devops-tp"
        registryCredential = 'e1711ed6-882a-4cef-bf52-e6200f122bd1'
        dockerImage = ''
    }
    agent any
    stages {
...
/*
  ...
  /*  post {
        ...
        post {
                    ...
                    success {
                        mail to: "siwar.brahmi@esprit.tn",
